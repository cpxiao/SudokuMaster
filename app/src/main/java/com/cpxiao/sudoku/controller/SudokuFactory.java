...
public class SudokuFactory {
    ...
    public int[][] keepInitNumbersByDifficulty(int[][] sudoku, int gameDifficulty) {
        ...
        int initNumbers = getInitNumbersByDifficulty(gameDifficulty);
    ...
    private int getInitNumbersByDifficulty(int gameDifficulty) {
        ...
        int result = (int) (tmp * mNumberCount * mNumberCount) + mRandom.nextInt(mBigBlockCountX);

        if (DEBUG) {
            result = mNumberCount * mNumberCount - 1;
        }
        return result;
    }
